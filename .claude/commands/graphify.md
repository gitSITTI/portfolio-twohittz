---
description: Build (or refresh) the knowledge graph for portfolio-twohittz and push the result into OB1 + SosaClaw open_brain.
---

# `/graphify` — portfolio-twohittz
...
3. Pushes a public-safe summary to OB1 via `ob1-bridge`:
   ```bash
   python /home/user/twohittz-source-hub/tools/scaffold/post_graph_capture.py --repo portfolio-twohittz
   ```
